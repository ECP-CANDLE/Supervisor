...
def run(gParameters):
    ...
    def focal_loss(gamma=2.0, alpha=0.25):
        ...
        def focal_loss_fixed(y_true, y_pred):
            ...
            return -K.sum(
                alpha * K.pow(1.0 - pt_1, gamma) * K.log(pt_1)) - K.sum(
    ...
    def get_unet():
        ...
        up6 = concatenate(
            [
                Conv2DTranspose(
                    filt_size, (2, 2), strides=(2, 2), padding="same")(conv5),
                conv4,
            ],
            axis=3,
        )
        ...
        up7 = concatenate(
            [
                Conv2DTranspose(
                    filt_size, (2, 2), strides=(2, 2), padding="same")(conv6),
                conv3,
            ],
            axis=3,
        )
        ...
        up8 = concatenate(
            [
                Conv2DTranspose(
                    filt_size, (2, 2), strides=(2, 2), padding="same")(conv7),
                conv2,
            ],
            axis=3,
        )
        ...
        up9 = concatenate(
            [
                Conv2DTranspose(
                    filt_size, (2, 2), strides=(2, 2), padding="same")(conv8),
                conv1,
            ],
            axis=3,
        )
