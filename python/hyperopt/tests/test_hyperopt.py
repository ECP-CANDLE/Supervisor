...
import numpy as np
from hyperopt import base, hp, rand, tpe
...
class TestHyperopt(unittest.TestCase):
    ...
    def test_eqpy(self):
        ...
        while True:
            ...
            rs = ",".join([
                str(math.sin(ast.literal_eval(r)["x"][0])) for r in split_result
            ])
    ...
    def test_no_seed(self):
        """Tests that passing no seed to eqpy_hyperopt doesn't raise an
        exception."""
