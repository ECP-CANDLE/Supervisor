...
export SWIFT_T_PREFIX=$ROOT/swift-t/2019-10-15
...
PYTHON_EXE=$ROOT/Python-3.5.1/bin/python3
...
LD_LIBRARY_PATH+=:/gpfs/alpine/world-shared/med106/sw/gcc-7.4.0/Python-3.5.1/lib
