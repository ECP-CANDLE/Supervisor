...
git@github.com:CODARcode/SwiftExamples.git[CODARCode/SwiftExamples] SimpleSweepCommandLine
...
git@github.com:CODARcode/SwiftExamples.git[CODARCode/SwiftExamples] SimpleSweepPython
...
git@github.com:CODARcode/SwiftExamples.git[CODARCode/SwiftExamples] SimpleSweepPyDB
