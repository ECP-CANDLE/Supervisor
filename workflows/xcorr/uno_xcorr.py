...
def select_features(df, study_col, study="all"):
    """Selects and returns a data frame from features whose study is equal to
    the specified study. If study is 'all' then all features are returned.
