...
usage()
{
  echo "Usage: test SIF SITE RUN_DIR(optional)"
...
export CFG_SYS=$THIS/cfg-sys-paccmann-1.sh
export CFG_PRM=$THIS/cfg-prm-paccmann-1.sh
export PARAM_SET_FILE=paccmann_param_space.json
...
export CANDLE_IMAGE=$MODEL_NAME
