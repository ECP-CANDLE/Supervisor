...
class RunChainedTests(unittest.TestCase):
    ...
    def test_root_nodes(self):
        ...
        first_stage = 1
        n_nodes = 4
        root_nodes = run_chained.compute_parent_nodes(root_node, first_stage,
                                                      n_nodes)
    ...
    def test_upfs(self):
        ...
        upfs, runs_per_stage = run_chained.generate_upfs(
            "test_upf", cfg, root_nodes, 4)
