...
usage()
{
  echo "infer_workflow.sh: usage: infer_workflow.sh SITE EXPID CFG_SYS CFG_PRM MODEL_NAME"
}
...
export MODEL_SH=$EMEWS_PROJECT_ROOT/sh/infer.sh
...
swift-t -V -n $PROCS -o workflow.tic \
        ...
        -e IGNORE_ERRORS \
        $WAIT_ARG \
        $EMEWS_PROJECT_ROOT/swift/infer_workflow.swift ${CMD_LINE_ARGS[@]}
