...
# CP-LEAVEOUT UPF WORKFLOW
# Main entry point for CP-LEAVEOUT UPF workflow
...
usage()
{
  echo "cp-leaveout-upf.sh: usage: cp-leaveout-upf.sh SITE EXPID CFG_SYS CFG_PRM MODEL_NAME"
}
