...
def run():
    ...
    (num_iter, num_pop, seed, strategy, mut_prob, cx_prob, mut_indpb, cx_indpb, tournsize, ga_params_file, 
            param_file) = eval("{}".format(params)) # RW: Add mut_indpb, cx_indpb, tournsize so that they're not hard-coded
