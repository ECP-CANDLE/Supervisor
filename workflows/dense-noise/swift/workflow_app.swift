...
string train_sources1 = argv("train1");
string train_sources2 = argv("train2");
...
/*
 ...
 NCI60
*/
printf("train_sources1: " + train_sources1);
printf("train_sources2: " + train_sources2);
...
json_template = """
{
  ...
  "noise"      : %5.2f,
  "epochs"     : %2i,
  "cmp_0_train_sources" : "%s",
  "cmp_1_train_sources" : "%s",
  "experiment_id": "%s",
  "run_id":        "%s",
  ...
  foreach levely, j in y_noise_levels
  {
    foreach trial, k in trials
    {
      ...
      params = json_template %
        (neuron, y_noise_level, epochs, train_sources1, train_sources2, exp_id, run_id);
